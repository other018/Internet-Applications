...
<head>
	...
	<?php
		...
		echo $this->Html->css('own');
		echo $this->Html->css('sponsorsStyle');
	...
	<div id="container">
		...
		<div id="content">
			...
			<div class="actions">
				...
				<ul>
					<?php echo $this->fetch('viewActions'); ?>
					<li><?php echo $this->Html->link(__('My profile'), array('controller' => 'users', 'action' => 'view')); ?></li>
